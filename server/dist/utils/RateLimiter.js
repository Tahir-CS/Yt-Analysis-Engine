...
class TokenBucketRateLimiter {
    ...
    maxTokens;
    refillRatePerSecond;
    constructor(platform, maxTokens, refillRatePerSecond) {
    ...
    async consume(tokens = 1) {
        ...
        const result = await redis.eval(luaScript, 1, this.key, tokens, this.maxTokens, this.refillRatePerSecond, now);
        return result === 1;
    }
}
