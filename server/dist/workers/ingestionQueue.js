...
exports.scheduleCreatorPolling = scheduleCreatorPolling;
 ...
 * ============================================================================
 */
exports.ingestionQueue = new bullmq_1.Queue('creator-ingestion', {
 ...
 */
async function scheduleCreatorPolling(creatorId, platform, platformId, cronExpression = '0 * * * *') {
    const jobName = `poll-${platform}-${creatorId}`;
    await exports.ingestionQueue.add(jobName, { creatorId, platform, platformId }, {
        repeat: {
